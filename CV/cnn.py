...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(scale = weight_scale, size = (num_filters * int(input_dim[1]/2) * int(input_dim[2]/2), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        loss2 = 0.5*self.reg*np.sum(self.params['W1']*self.params['W1']) + 0.5*self.reg*np.sum(self.params['W2']*self.params['W2']) + 0.5*self.reg*np.sum(self.params['W3']*self.params['W3'])
        loss += loss2
